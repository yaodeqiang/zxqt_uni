<template>
	<view class="loginView">
		...
		<view class="loginHedP">
			已有账号，立即<navigator url="../login/login" hover-class="none">登录</navigator>
		</view>
		...
		<form @submit="" @reset="">
			...
			<button class="login-goBtn" form-type="submit" @click="goNext">下一步</button>
		</form>
...
<script>
	export default {
		...
		methods: {
			goNext() {
				uni.navigateTo({
					url: '../register-smrz/register-smrz'
				});
			},
			getCode() {
				this.codeTextShow = 1;
